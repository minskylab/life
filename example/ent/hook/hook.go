...
// The AutorFunc type is an adapter to allow the use of ordinary
// function as Autor mutator.
type AutorFunc func(context.Context, *ent.AutorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AutorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AutorMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AutorMutation", m)
	}
	return f(ctx, mv)
}
